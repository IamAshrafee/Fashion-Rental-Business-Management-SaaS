...
| Hybrid inventory      | Product → variant/SKU → serialized item or pooled quantity, locations, buffers and date reservations                   | Inventory overview, SKU stock, physical items, availability, counts, transfers, inspections, issues and service work | Movement/lifecycle ledgers, optimistic versions, idempotency and concurrency tests               |
