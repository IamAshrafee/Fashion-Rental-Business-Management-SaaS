...
| **Unlocks** | P20 |
| **Agent Skills** | `nextjs-best-practices`, `nextjs-app-router-patterns`, `vercel-react-best-practices`, `tailwind-css-patterns` · Optional: `shadcn`, `tailwindcss-mobile-first` |
