...
| 33 | `sessions` | [../features/session-management.md](../features/session-management.md) | Yes |
| 34 | `login_history` | [../features/session-management.md](../features/session-management.md) | Yes |
| 35 | `starter_templates` | [seed-data.md](./seed-data.md) | No (global) |

**Deleted tables** (from brainstorming decisions):
- ~~`carts`~~ — Cart is client-side localStorage only (ADR-03)
- ~~`orders`~~ — Booking IS the order, unified entity (ADR-02)
