...
| **Acquisition Cost**       | Private amount invested in one exact physical item. Items under the same SKU may have different costs.                                                                                                                                                                         |
| **Reference Retail Value** | Optional product-level comparison or replacement context with an explicit public-display setting; separate from acquisition cost.                                                                                                                                              |
