        ...
        <Card className="overflow-hidden">
          <CardContent className="p-0">
            <div className="hidden overflow-x-auto md:block">
              <Table>
                <TableHeader><TableRow><TableHead>Product / SKU</TableHead><TableHead>Tracking</TableHead><TableHead>State</TableHead><TableHead className="text-right">On hand</TableHead><TableHead className="text-right">Reserved now</TableHead><TableHead className="text-right">Available now</TableHead><TableHead>Identity</TableHead><TableHead className="text-right">Action</TableHead></TableRow></TableHeader>
